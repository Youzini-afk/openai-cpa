...
from utils.proxy_manager import get_effective_default_proxy, smart_switch_node
...
def main() -> None:
    ...
    if getattr(cfg, 'ENABLE_NEURALWATT_MODE', False):
        print("   当前状态: [ Neuralwatt 仓管模式 ] 已开启")
    elif cfg.ENABLE_CPA_MODE:
    ...
    if getattr(cfg, 'ENABLE_NEURALWATT_MODE', False):
        ...
        try:
            neuralwatt_main_loop(args, stop_event)
